...
<?php
	...
	$req = mysql_query('select nom_salle, departement, adresse from salle where gerant_salle = "'.$_SESSION['pseudo'].'"');
	while($dnn = mysql_fetch_array($req))
	{
?>
	<tr class="recherche" onclick='document.location.href="salle.php?nom_salle=<?php echo $dnn['nom_salle']; ?>&annee=<?php echo date('Y');?>"'>
    	<td class="left"><?php echo htmlentities($dnn['nom_salle'], ENT_QUOTES, 'UTF-8'); ?></td>
