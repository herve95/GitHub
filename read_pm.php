...
$req2 = mysql_query('select pm.timestamp, pm.message, compte.id as id, compte.pseudo from pm, compte where pm.id="'.$id.'" and compte.id=pm.user1 order by pm.id2');
...
?>
	<tr>
    	<td class="author center"><br /><a href="profile.php?id=<?php echo $dn2['id']; ?>"><?php echo $dn2['pseudo']; ?></a></td>
