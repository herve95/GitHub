                 ...
                 <div class="componentPlaylist">
                     ...
                     <div class="playlist_inner">
							...
							<ul id='playlist1' data-type='local'>
								...
								$dn = mysql_query('select  chemin_musique ,titre from musique where nom_groupe="'.$nom_groupe.'"');
								while($dnn = mysql_fetch_array($dn))
								{
	
								?>
								
									<li class= "playlistItem" data-path=<?php echo htmlentities($dnn['chemin_musique'], ENT_QUOTES, 'UTF-8'); ?>><a class="playlistNonSelected" href='#'><?php echo htmlentities($dnn['titre'], ENT_QUOTES, 'UTF-8'); ?></a></li>
